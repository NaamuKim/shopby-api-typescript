  ...
  schemas: {
    "products-productNo-options-583998608": {
      ...
      inputs?: ({
           ...
           * @enum {string}
           */
          inputMatchingType?: "OPTION: By Option" | "PRODUCT: By Product" | "AMOUNT: By quantity";
          /**
       ...
       * @enum {string}
       */
      type?: "STANDARD: Standalone Option (ShopByPro: Text Option)" | "COMBINATION: Combination Option" | "DEFAULT: No option" | "MAPPING: Mapping (Shop Buy Premium only)";
      /**
       * @description 옵션명 목록
       * @example ["색상","사이즈"]
       */
    ...
    "products-best-seller-search1638148323": {
      ...
      items?: ({
           ...
           * @enum {string}
           */
          productType?: "DEFAULT: General product" | "EVENT: Event Product" | "OFFLINE: Offline product" | "RENTAL: Rental Product";
          /**
           * @description 상품번호
           * @example 10000001
           */
           ...
           * @enum {string}
           */
          saleStatusType?: "READY: Ready for sale" | "ONSALE: on sale" | "FINISHED: Sales Ended" | "STOP: Sale Stopped" | "PROHIBITION: Sell prohibited";
        })[];
    };
    "products-shipping-info-448668919": ({
        ...
        shippingInfo?: {
          ...
          shippingConfig?: {
             ...
             * @enum {string}
             */
            shippingAreaType?: "PARTNER_SHIPPING_AREA: Partner Shipping Center Shipping" | "MALL_SHIPPING_AREA: Shipping from shopping mall distribution center";
            /**
    ...
    "products-productNo989381871": {
      ...
      baseInfo?: {
         ...
         * @enum {string}
         */
        certificationType?: "TARGET: Certification Target" | "NOT_TARGET: Not subject to certification" | "DETAIL_PAGE: Separately mark the detail page";
        /**
         * @description 제조일자
         ...
         * @enum {string}
         */
        productGroup?: "DELIVERY: Delivery Group" | "SERVICE: Service Product Group";
        /**
         * @description 판매시작일시
         * @example "2024-01-04 16:11:07"
         */
      ...
      status?: {
         ...
         * @enum {string}
         */
        productClassType?: "DEFAULT: General product" | "EVENT: Event Product" | "OFFLINE: Offline product" | "RENTAL: Rental Product";
        /**
         * @description 전시여부
         * @example true
         */
    ...
    "products-group-management-code-1777856279": ({
        ...
        groupManagementMappingProducts?: ({
             ...
             * @enum {string}
             */
            optionType?: "STANDARD: Standalone Option (ShopByPro: Text Option)" | "COMBINATION: Combination Option" | "DEFAULT: No option" | "MAPPING: Mapping (Shop Buy Premium only)";
            /**
    ...
    "free-gift-condition-productNo1611589026": {
      ...
      freeGiftConditions?: ({
           ...
           * @enum {string}
           */
          limitedMemberType?: "전체 : ALL" | "비회원 불가: MEMBER" | "회원등급/그룹 : TARGET";
          /**
           * @description 시작일
